...
namespace LinearAlgebra.Matricies 
{
    public class DoubleMatrix 
    {
        ...
        protected static double[] Multiplication(
           ...
           double[] vector)
        {
            double[] result = new double[matrix.ColumnCount];
        ...
        public static double[] operator *(DoubleMatrix matrix, double[] vect)//My
        {
            return DoubleMatrix.Multiplication(matrix, vect);
        }
